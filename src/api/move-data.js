export const get_actions = () => {
  return fetch(`http://${process.env.REACT_APP_API_URL}/actions`).then((res) =>
    res.json()
  );
};

export const get_routines = () => {
  return fetch(`http://${process.env.REACT_APP_API_URL}/routines`).then((res) =>
    res.json()
  );
};

export const get_schedules = () => {
  return fetch(`http://${process.env.REACT_APP_API_URL}/schedules`).then(
    (res) => res.json()
  );
};

export const get_events = () => {
  return fetch(`http://${process.env.REACT_APP_API_URL}/events`).then((res) =>
    res.json()
  );
};

export const get_scripts = () => {
  return fetch(`http://${process.env.REACT_APP_API_URL}/scripts`).then((res) =>
    res.json()
  );
};
