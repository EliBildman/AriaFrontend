...
const ScheduleContents = (props) => {
    ...
    const { routine_sequence, routines, update, updateCron, _delete, cron_string } = props
    ...
    const handleKeyPress = useCallback((schedule) => { // handle keybinds
    ...
    return (
        <List style={{padding: 0}}>
            <ScheduleControlPanel cron_string={cron_string} updateCron={updateCron}  _delete={_delete} add={() => {setShowAddition(true)}} />
            {routine_items}
